...
import { FiYoutube, FiLinkedin, FiGithub, FiInstagram, FiFacebook } from "react-icons/fi";
...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: FiLinkedin,
    url: "https://www.linkedin.com/in/im-abrarhossen/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@whose_abrar",
    icon: FiInstagram,
    url: "https://www.instagram.com/whose_abrar/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@ASAThreeIdiots",
    icon: FiYoutube,
    url: "https://www.youtube.com/@ASAThreeIdiots",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@im-AbrarHossen",
    icon: FiGithub,
    url: "https://github.com/im-AbrarHossen",
    color: "#ffffff",
  ...
  },
  {
    ...
    subText: "@abrarhossen273",
    icon: FiFacebook,
    url: "https://www.facebook.com/abrarhossen273",
    color: "#1877F2",
